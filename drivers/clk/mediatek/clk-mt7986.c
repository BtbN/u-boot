...
static const struct mtk_fixed_factor top_fixed_divs[] = {
	PLL_FACTOR(CK_TOP_CB_M_416M, "cb_m_416m", CLK_APMIXED_MPLL, 1, 1),
	PLL_FACTOR(CLK_TOP_MPLL_D2, "cb_m_d2", CLK_APMIXED_MPLL, 1, 2),
	PLL_FACTOR(CK_TOP_CB_M_D4, "cb_m_d4", CLK_APMIXED_MPLL, 1, 4),
	PLL_FACTOR(CK_TOP_CB_M_D8, "cb_m_d8", CLK_APMIXED_MPLL, 1, 8),
	PLL_FACTOR(CK_TOP_M_D8_D2, "m_d8_d2", CLK_APMIXED_MPLL, 1, 16),
	PLL_FACTOR(CK_TOP_M_D3_D2, "m_d3_d2", CLK_APMIXED_MPLL, 1, 2),
	...
	PLL_FACTOR(CLK_TOP_NET1PLL_D5_D2, "net1_d5_d2", CK_APMIXED_NET1PLL, 1, 10),
	...
	PLL_FACTOR(CK_TOP_CB_NET2_800M, "cb_net2_800m", CLK_APMIXED_NET2PLL, 1,
		   1),
	PLL_FACTOR(CK_TOP_CB_NET2_D4, "cb_net2_d4", CLK_APMIXED_NET2PLL, 1, 4),
	PLL_FACTOR(CK_TOP_NET2_D4_D2, "net2_d4_d2", CLK_APMIXED_NET2PLL, 1, 8),
	PLL_FACTOR(CK_TOP_NET2_D3_D2, "net2_d3_d2", CLK_APMIXED_NET2PLL, 1, 2),
	...
	PLL_FACTOR(CK_TOP_WEDMCU_D5_D2, "wedmcu_d5_d2", CK_APMIXED_WEDMCUPLL, 1,
		   10),
	PLL_FACTOR(CK_TOP_CB_SGM_325M, "cb_sgm_325m", CLK_APMIXED_SGMPLL, 1, 1),
	TOP_FACTOR(CK_TOP_CB_CKSQ_40M_D2, "cb_cksq_40m_d2", CLK_TOP_CB_CKSQ_40M,
		   1, 2),
	TOP_FACTOR(CK_TOP_CB_RTC_32K, "cb_rtc_32k", CLK_TOP_CB_CKSQ_40M, 1,
		   1250),
	TOP_FACTOR(CK_TOP_CB_RTC_32P7K, "cb_rtc_32p7k", CLK_TOP_CB_CKSQ_40M, 1,
		   1220),
	TOP_FACTOR(CK_TOP_NFI1X, "nfi1x", CK_TOP_NFI1X_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_USB_EQ_RX250M, "usb_eq_rx250m", CLK_TOP_CB_CKSQ_40M, 1,
		   1),
	TOP_FACTOR(CK_TOP_USB_TX250M, "usb_tx250m", CLK_TOP_CB_CKSQ_40M, 1, 1),
	TOP_FACTOR(CK_TOP_USB_LN0_CK, "usb_ln0", CLK_TOP_CB_CKSQ_40M, 1, 1),
	TOP_FACTOR(CK_TOP_USB_CDR_CK, "usb_cdr", CLK_TOP_CB_CKSQ_40M, 1, 1),
	TOP_FACTOR(CK_TOP_SPINFI_BCK, "spinfi_bck", CK_TOP_SPINFI_SEL, 1, 1),
	TOP_FACTOR(CLK_TOP_I2C_BCK, "i2c_bck", CK_TOP_I2C_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_PEXTP_TL, "pextp_tl", CK_TOP_PEXTP_TL_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_EMMC_250M, "emmc_250m", CLK_TOP_EMMC_250M_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_EMMC_416M, "emmc_416m", CLK_TOP_EMMC_416M_SEL, 1, 1),
	...
	TOP_FACTOR(CK_TOP_NETSYS_2X, "netsys_2x", CLK_TOP_NETSYS_2X_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_SGM_325M, "sgm_325m", CLK_TOP_SGM_325M_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_A1SYS, "a1sys", CK_TOP_A1SYS_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_EIP_B, "eip_b", CLK_TOP_EIP_B_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_F26M, "csw_f26m", CLK_TOP_F26M_SEL, 1, 1),
	...
	TOP_FACTOR(CK_TOP_U2U3_XHCI, "u2u3_xhci", CLK_TOP_U2U3_XHCI_SEL, 1, 1),
	TOP_FACTOR(CK_TOP_AP2CNN_HOST, "ap2cnn_host", CLK_TOP_AP2CNN_HOST_SEL, 1,
		   1),
};

/* TOPCKGEN MUX PARENTS */
static const int nfi1x_parents[] = { CLK_TOP_CB_CKSQ_40M,  CK_TOP_CB_MM_D8,
...
static const int spinfi_parents[] = {
	CK_TOP_CB_CKSQ_40M_D2, CLK_TOP_CB_CKSQ_40M, CK_TOP_NET1_D5_D4,
	CK_TOP_CB_M_D4,	CK_TOP_MM_D8_D2,    CK_TOP_WEDMCU_D5_D2,
	CK_TOP_MM_D3_D8,       CK_TOP_CB_M_D8
};

static const int spi_parents[] = { CLK_TOP_CB_CKSQ_40M, CLK_TOP_MPLL_D2,
				   CK_TOP_CB_MM_D8,    CK_TOP_NET1_D8_D2,
				   CK_TOP_NET2_D3_D2,  CK_TOP_NET1_D5_D4,
				   CK_TOP_CB_M_D4,     CK_TOP_WEDMCU_D5_D2 };

static const int uart_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_CB_M_D8,
				    CK_TOP_M_D8_D2 };

static const int pwm_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_NET1_D8_D2,
				   CK_TOP_NET1_D5_D4, CK_TOP_CB_M_D4 };

static const int i2c_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_NET1_D5_D4,
...
static const int emmc_250m_parents[] = { CLK_TOP_CB_CKSQ_40M,
					 CLK_TOP_NET1PLL_D5_D2 };

static const int emmc_416m_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_CB_M_416M };

static const int f_26m_adc_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_M_D8_D2 };

static const int dramc_md32_parents[] = { CLK_TOP_CB_CKSQ_40M, CLK_TOP_MPLL_D2 };

static const int sysaxi_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_NET1_D8_D2,
				      CK_TOP_CB_NET2_D4 };

static const int sysapb_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_M_D3_D2,
				      CK_TOP_NET2_D4_D2 };

static const int arm_db_main_parents[] = { CLK_TOP_CB_CKSQ_40M,
					   CK_TOP_NET2_D3_D2 };

static const int arm_db_jtsel_parents[] = { -1, CLK_TOP_CB_CKSQ_40M };

static const int netsys_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_CB_MM_D4 };

static const int netsys_500m_parents[] = { CLK_TOP_CB_CKSQ_40M,
					   CK_TOP_CB_NET1_D5 };

static const int netsys_mcu_parents[] = { CLK_TOP_CB_CKSQ_40M,
...
static const int sgm_reg_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_NET1_D8_D4 };

static const int a1sys_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_APLL2_D4 };

static const int conn_mcusys_parents[] = { CLK_TOP_CB_CKSQ_40M,
					   CK_TOP_CB_MM_D2 };

static const int eip_b_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_CB_NET2_800M };

static const int aud_l_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_CB_APLL2_196M,
				     CK_TOP_M_D8_D2 };

static const int a_tuner_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_APLL2_D4,
				       CK_TOP_M_D8_D2 };

static const int u2u3_sys_parents[] = { CLK_TOP_CB_CKSQ_40M, CK_TOP_NET1_D5_D4 };

static const int da_u2_refsel_parents[] = { CLK_TOP_CB_CKSQ_40M,
...
static const struct mtk_fixed_factor infra_fixed_divs[] = {
	TOP_FACTOR(CK_INFRA_CK_F26M, "infra_ck_f26m", CLK_TOP_F26M_SEL, 1, 1),
	TOP_FACTOR(CLK_INFRA_UART, "infra_uart", CLK_TOP_UART_SEL, 1, 1),
	TOP_FACTOR(CK_INFRA_ISPI0, "infra_ispi0", CLK_TOP_SPI_SEL, 1, 1),
	TOP_FACTOR(CK_INFRA_I2C, "infra_i2c", CK_TOP_I2C_SEL, 1, 1),
	TOP_FACTOR(CK_INFRA_ISPI1, "infra_ispi1", CK_TOP_SPINFI_SEL, 1, 1),
	TOP_FACTOR(CK_INFRA_PWM, "infra_pwm", CLK_TOP_PWM_SEL, 1, 1),
	...
	TOP_FACTOR(CK_INFRA_FAUD_EG2_CK, "infra_faud_eg2", CK_TOP_A_TUNER, 1,
		   1),
	TOP_FACTOR(CLK_INFRA_I2CS_CK, "infra_i2cs", CLK_TOP_I2C_BCK, 1, 1),
	INFRA_FACTOR(CK_INFRA_MUX_UART0, "infra_mux_uart0", CLK_INFRA_UART0_SEL,
		     1, 1),
	INFRA_FACTOR(CK_INFRA_MUX_UART1, "infra_mux_uart1", CLK_INFRA_UART1_SEL,
		     1, 1),
	INFRA_FACTOR(CK_INFRA_MUX_UART2, "infra_mux_uart2", CLK_INFRA_UART2_SEL,
		     1, 1),
...
static const int infra_uart0_parents[] = { CK_INFRA_CK_F26M, CLK_INFRA_UART };

static const int infra_spi0_parents[] = { CK_INFRA_I2C, CLK_INFRA_SPI0_CK };
...
static const struct mtk_gate infracfg_ao_gates[] = {
	...
	GATE_INFRA0(CLK_INFRA_PWM_STA, "infra_pwm_sta", CK_INFRA_PWM_BCK, 2),
	GATE_INFRA0(CLK_INFRA_PWM1_CK, "infra_pwm1", CK_INFRA_PWM_CK1, 3),
	GATE_INFRA0(CLK_INFRA_PWM2_CK, "infra_pwm2", CK_INFRA_PWM_CK2, 4),
	GATE_INFRA0(CK_INFRA_CQ_DMA_CK, "infra_cq_dma", CK_INFRA_133M_HCK, 6),
	GATE_INFRA0(CLK_INFRA_EIP97_CK, "infra_eip97", CK_INFRA_EIP_CK, 7),
	...
	GATE_INFRA0(CLK_INFRA_AP_DMA_CK, "infra_ap_dma", CK_INFRA_66M_MCK, 16),
	...
	GATE_INFRA0(CLK_INFRA_TRNG_CK, "infra_trng", CK_INFRA_HD_133M, 26),
	/* INFRA1 */
	GATE_INFRA1(CLK_INFRA_THERM_CK, "infra_therm", CK_INFRA_CK_F26M, 0),
	GATE_INFRA1(CLK_INFRA_I2C0_CK, "infra_i2c0", CLK_INFRA_I2CS_CK, 1),//parent is wrong i2c_sel in linux
	GATE_INFRA1(CLK_INFRA_UART0_CK, "infra_uart0", CK_INFRA_MUX_UART0, 2),
	GATE_INFRA1(CLK_INFRA_UART1_CK, "infra_uart1", CK_INFRA_MUX_UART1, 3),
	GATE_INFRA1(CLK_INFRA_UART2_CK, "infra_uart2", CK_INFRA_MUX_UART2, 4),
	...
	GATE_INFRA1(CLK_INFRA_SPI0_CK, "infra_spi0", CK_INFRA_MUX_SPI0, 11),
	GATE_INFRA1(CLK_INFRA_SPI1_CK, "infra_spi1", CK_INFRA_MUX_SPI1, 12),
	GATE_INFRA1(CLK_INFRA_SPI0_HCK_CK, "infra_spi0_hck", CK_INFRA_66M_MCK,
		    13),
	GATE_INFRA1(CLK_INFRA_SPI1_HCK_CK, "infra_spi1_hck", CK_INFRA_66M_MCK,
		    14),
	GATE_INFRA1(CK_INFRA_FRTC_CK, "infra_frtc", CK_INFRA_RTC_32K, 15),
	GATE_INFRA1(CLK_INFRA_MSDC_CK, "infra_msdc", CK_INFRA_FMSDC_CK, 16),
	GATE_INFRA1(CLK_INFRA_MSDC_HCK_CK, "infra_msdc_hck",
		    CK_INFRA_FMSDC_HCK_CK, 17),
	GATE_INFRA1(CLK_INFRA_MSDC_133M_CK, "infra_msdc_133m",
		    CK_INFRA_PERI_133M, 18),
	GATE_INFRA1(CLK_INFRA_MSDC_66M_CK, "infra_msdc_66m", CK_INFRA_66M_PHCK,
		    19),
	GATE_INFRA1(CLK_INFRA_ADC_26M_CK, "infra_adc_26m", CK_INFRA_CK_F26M, 20),
	GATE_INFRA1(CLK_INFRA_ADC_FRC_CK, "infra_adc_frc", CK_INFRA_CK_F26M, 21),
	GATE_INFRA1(CK_INFRA_FBIST2FPC_CK, "infra_fbist2fpc", CK_INFRA_NFI_CK,
		    23),
	/* INFRA2 */
	GATE_INFRA2(CLK_INFRA_IUSB_133_CK, "infra_iusb_133", CK_INFRA_133M_PHCK,
		    0),
	GATE_INFRA2(CLK_INFRA_IUSB_66M_CK, "infra_iusb_66m", CK_INFRA_66M_PHCK,
		    1),
	GATE_INFRA2(CLK_INFRA_IUSB_SYS_CK, "infra_iusb_sys", CK_INFRA_USB_SYS_CK,
		    2),
	GATE_INFRA2(CLK_INFRA_IUSB_CK, "infra_iusb", CK_INFRA_USB_CK, 3),
	GATE_INFRA2(CLK_INFRA_IPCIE_CK, "infra_ipcie", CK_INFRA_PCIE_CK, 12),
	GATE_INFRA2(CLK_INFRA_IPCIE_PIPE_CK, "infra_ipcie_pipe", CK_INFRA_PCIE_CK, 13),
	GATE_INFRA2(CLK_INFRA_IPCIER_CK, "infra_ipcier", CK_INFRA_F26M_CK0, 14),
	GATE_INFRA2(CLK_INFRA_IPCIEB_CK, "infra_ipcieb", CK_INFRA_133M_PHCK, 15),
};
...
static const struct mtk_gate eth_cgs[] = {
	GATE_ETH(CLK_ETH_FE_EN, "eth_fe_en", CK_TOP_NETSYS_2X, 7),
	GATE_ETH(CLK_ETH_GP2_EN, "eth_gp2_en", CK_TOP_SGM_325M, 8),
	GATE_ETH(CLK_ETH_GP1_EN, "eth_gp1_en", CK_TOP_SGM_325M, 8),
	GATE_ETH(CLK_ETH_WOCPU1_EN, "eth_wocpu1_en", CK_TOP_NETSYS_WED_MCU, 14),
	GATE_ETH(CLK_ETH_WOCPU0_EN, "eth_wocpu0_en", CK_TOP_NETSYS_WED_MCU, 15),
};
